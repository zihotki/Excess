...
{
    internal sealed class Configuration : DbMigrationsConfiguration<ExcessDbContext>
    {
        private static readonly Guid ContractUsage = new Guid("E8FB63DB-D135-4FE9-893A-24A4162A1D0B");
        private static readonly Guid MatchUsage = new Guid("6C3371F4-59AD-4D74-91BA-50C5A9424632");
        private static readonly Guid AsynchUsage = new Guid("834A3BDB-40A4-4025-8588-FB341C22A2E6");
        ...
        {
            for (var i = projectFileSamples; i < reserveCount; i++)
            {
        ...
        {
            for (var i = projectSamples; i < reserveCount; i++)
            {
